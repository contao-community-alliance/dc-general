    ...
    public function handleEvent(GetSelectModeButtonsEvent $event)
    {
        ...
        $confirmMessage = \htmlentities(
            \sprintf(
                ...
                '</div>',
                \specialchars($translator->translate('MSC.nothingSelect')),
                'tl_submit',
                \specialchars($translator->translate('MSC.close')),
        ...
        if ($basicDefinition->isDeletable()) {
            $onClickDelete = \sprintf(
                ...
                'models[]',
                $confirmMessage,
                \specialchars($translator->translate('MSC.delAllConfirm')),
                \specialchars($translator->translate('MSC.confirmOk')),
                \specialchars($translator->translate('MSC.confirmAbort'))
            );
            ...
            $buttons['delete'] = \sprintf(
                ...
                'delete',
                'd',
                \specialchars($translator->translate('MSC.deleteSelected')),
                $onClickDelete
            );
        }
        ...
        if ($sortingProperty && $basicDefinition->isEditable()) {
            $buttons['cut'] = \sprintf(
                ...
                'cut',
                's',
                \specialchars($translator->translate('MSC.moveSelected')),
                $onClick
            );
        }
        ...
        if ($basicDefinition->isCreatable()) {
            $buttons['copy'] = \sprintf(
                ...
                'copy',
                'c',
                \specialchars($translator->translate('MSC.copySelected')),
                $onClick
            );
        }
        ...
        if ($basicDefinition->isEditable()) {
            $buttons['override'] = \sprintf(
                ...
                'override',
                'v',
                \specialchars($translator->translate('MSC.overrideSelected')),
                $onClick
            );
            ...
            $buttons['edit'] = \sprintf(
                ...
                'edit',
                's',
                \specialchars($translator->translate('MSC.editSelected')),
                $onClick
            );
        }
