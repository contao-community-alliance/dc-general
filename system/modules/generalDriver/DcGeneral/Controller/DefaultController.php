...
class DefaultController extends \Controller implements ControllerInterface
{
	...
	protected function checkLanguage()
	{
		...
		if (in_array('InterfaceGeneralDataMultiLanguage', class_implements($objDataProvider))
			|| in_array('MultiLanguageDriverInterface', class_implements($objDataProvider))
			|| in_array('DcGeneral\Data\MultiLanguageDriverInterface', class_implements($objDataProvider)))
		{
